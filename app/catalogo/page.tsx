...
// Página de detalle para cada vehículo. Muestra galería, información básica,
// enlaces para consultar o ver en Mercado Libre y un listado de recomendaciones.
export default async function VehicleDetailPage({ params }: PageProps) {
  ...
  // Obtener vehículos para recomendaciones
        ...
        <div className="space-y-4">
          ...
          <div className="flex flex-wrap gap-3 pt-4">
            ...
            {process.env.NEXT_PUBLIC_WAPP && (
              <a
                href={`https://api.whatsapp.com/send?phone=${process.env.NEXT_PUBLIC_WAPP}&text=Hola,%20estoy%20interesado%20en%20${encodeURIComponent(
                  vehicle.title || ''
                )}`}
                target="_blank"
            ...
            {/* Enlace a Mercado Libre (opcional) */}
            {vehicle.permalink && (
              <a
